  ...
  <section class="flex flex-col space-y-4">
    ...
    <div class="bg-card rounded-lg shadow-md p-4 text-text">
      ...
      <div class="mt-4">
        ...
        <button @click="buyTicket" :disabled="loading || status != 1"
    ...
    <el-table :data="tableData" class="bg-card rounded-lg shadow-md p-4 text-text" row-key="id" border
      default-expand-all>
      <el-table-column prop="round" label="Round" sortable />
      <el-table-column prop="prize" label="Prize Pool" sortable />
